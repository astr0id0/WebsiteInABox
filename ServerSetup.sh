...
newservername='mail.thecovidresponse.com'					#The server will be renamed to whatever this is set to - the domain should match your web domain
...
newadminpw='Tyr@annyTr@cker!'								#It should be customized to your liking by default it will be added to the docker group + have sudo priveledge								
