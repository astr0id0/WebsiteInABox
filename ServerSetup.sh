...
newservername='mail.websitedomain.com'					#The server will be renamed to whatever this is set to - the domain should match your web domain
domain='websitedomain.com'									#I chose the name HomeBase because it is going to be running Mail, Web, etc -- its the Home Base of Operations
...
newadminuser='newadmin'  											#This user will be able to launch docker without sudo, and have elevated priveledge
